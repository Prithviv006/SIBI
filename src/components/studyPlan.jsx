  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8 ">
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div 
          data-aos="fade-up" 
          className="bg-white backdrop-blur-lg  bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl shadow-xl p-8 space-y-6 border border-opacity-10 border-white"
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit" style={{width:"30%",marginLeft:"30%",marginTop:"2%  "}}
